...
public:
    ...
    void solve(std::istream &in, std::ostream &out) {
        ...
        rf(i, 1, 1e7)s[i] += s[i - 1];
        int m;
        in >> m;
        rf(i, 1, m) {
            int l, r;
            in >> l >> r;
            out << s[min(r, (int) 1e7)] - s[min(l - 1, (int) 1e7)] << '\n';
        }
...
public:
    ...
    static void generateTest(std::ostream &test) {
        int n;
        n = randInt(1, 10);
        vi a = randArr(n, 1, (int) 100);
        int m = randInt(1, 10);
        vii q = randArrPair(m, 1, 2, 100);
        test << n << "\n" << to_string(a) << "\n" << m << "\n" << to_string(q) << "\n";
    }
...
public:
    ...
    static bool check(std::istream &in, std::istream &out) {
    }
};
