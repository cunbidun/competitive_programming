...
public class Main {
    public static void main(String[] args) {
        ...
        CSadPowers solver = new CSadPowers();
        solver.solve(1, in, out);
        out.close();
    }

    static class CSadPowers {
...
//        out.println();
        ...
        private long cal(long x) {
            return sqrt(x) + BinarySearch.lessOrEqualThan(list, x);
        }
    ...
    static class BinarySearch {
        ...
        public static int lessOrEqualThan(TreeList<Long> array, int indexSt, int indexEn, long value) {
            int pos = upperBound(array, indexSt, indexEn, value);
            return pos - indexSt;
        }

        public static int lessOrEqualThan(TreeList<Long> array, long value) {
            return lessOrEqualThan(array, 0, array.size() - 1, value);
        }
