...
public class Main {
    public static void main(String[] args) {
        ...
        BYetAnotherArrayPartitioningTask solver = new BYetAnotherArrayPartitioningTask();
        solver.solve(1, in, out);
        out.close();
    }

    static class BYetAnotherArrayPartitioningTask {
        ...
        public void solve(int testNumber, InputReader in, PrintWriter out) {
            ...
            int m = in.nextInt();
            int k = in.nextInt();
            PairLI[] a = new PairLI[MAXA];
            for (int i = 1; i <= n; i++) {
                a[i] = new PairLI(in.nextLong(), i);
            }
            Arrays.sort(a, 1, n + 1);
