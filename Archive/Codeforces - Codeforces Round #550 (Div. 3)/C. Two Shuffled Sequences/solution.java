...
public class Main {
    public static void main(String[] args) {
        ...
        CTwoShuffledSequences solver = new CTwoShuffledSequences();
        solver.solve(1, in, out);
        out.close();
    }

    static class CTwoShuffledSequences {
    ...
    static class QuickSort {
        public static void sort(int[] list, int lowIndex, int highIndex) {
            Shuffle.shuffleArray(list, lowIndex, highIndex);
    ...
    static class Shuffle {
        static void shuffleArray(int[] array, int stIndex, int enIndex) {
