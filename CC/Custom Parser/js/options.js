...
const customPortsInput = document.querySelector('#custom-ports');
...
customPortsInput.addEventListener('input', function () {
    ...
    if (uniquePorts.some(isNaN) || uniquePorts.some(x => x < 0)) {
        document.querySelector('#custom-ports-error').style.display = 'block';
    }
    else {
        document.querySelector('#custom-ports-error').style.display = 'none';
        config_1.config
