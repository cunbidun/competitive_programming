...
int cal(int ff, int ss) {
  ...
  if (ss == 1) {
    f[n][1][0] = min(f[n][1][0], (a[n] != 1) + f[n - 1][0][1]);
    f[n][1][0] = min(f[n][1][0], (a[n] != 1) + f[n - 1][0][0]);
    f[n][1][1] = min(f[n][1][1], (a[n] != 1) + f[n - 1][1][0]);
  } else {
    f[n][0][0] = min(f[n][0][0], (a[n] != 0) + f[n - 1][0][1]);
    f[n][0][1] = min(f[n][0][1], (a[n] != 0) + f[n - 1][1][0]);
    f[n][0][1] = min(f[n][0][1], (a[n] != 0) + f[n - 1][1][1]);
  }
